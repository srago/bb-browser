...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:Teuw3X3UppglTn8we8zzv7xMGDA+VnfzX118NbMZ0N8=",
        version = "v1.12.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:YEz2KMyqK2zyG3uOa0l2xBc/H6NUVJir8FhwHQHF3rc=",
        version = "v1.7.1",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_service_s3",
        importpath = "github.com/aws/aws-sdk-go-v2/service/s3",
        sum = "h1:dt1JQFj/135ozwGIWeCM3aQ8N/kB3Xu3Uu4r9zuOIyc=",
        version = "v1.16.0",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_service_sqs",
        importpath = "github.com/aws/aws-sdk-go-v2/service/sqs",
        sum = "h1:8m+6iuSldxMrVQbjHRcWPnUxdpD3RCPtacmFFNkR4Vw=",
        version = "v1.9.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Gghj9/p4SnZhjio+DKUp03K2jYxkGQP4QRpEylWlXc0=",
        version = "v0.0.0-20211009082456-49b2d95ca693",
    )
    go_repository(
        name = "com_github_buildbarn_bb_storage",
        importpath = "github.com/buildbarn/bb-storage",
        sum = "h1:u8iMR2cUyl9Lu1CGAwckHl1BSWNhL+3+vcf1lrcvuBI=",
        version = "v0.0.0-20211009063419-74e925917e4c",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:fg9udWIWWJMAT+Gq2ATFd/DFy3OZvKEZy9VK2amxvkw=",
        version = "v1.0.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:33YYJanAOLxgS7pGjzC1IUrFLpwN//bbgtnKYikOmQU=",
        version = "v0.0.0-20211008145708-270636b82663",
    )
    go_repository(
